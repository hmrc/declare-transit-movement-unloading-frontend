...
class TransportSectionSpec extends SpecBase {
  ...
  "TransportSection" - {
    ...
    "contain data from unloading permission" - {
      "display correct transport Indentity number when no changes have been made" in {
      ...
      "display correct transport country when no changes have been made " in {
    ...
    "contain data from user answers" - {
